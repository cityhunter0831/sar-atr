...
path2mstar='C:/Users/kkand/Desktop/25-2 academics/mstar_data_aug/data/mstar_train';
fileNamePrefix = {'2S1','BMP2_SN_9563','BMP2_SN_9566','BMP2_SN_C21',...
                'BTR70_SN_C71','T72_SN_132','T72_SN_812','T72_SN_S7','ZSU_23_4'};
extensions = {'000','000','001','002','004','015','016','017','026'};
...
for idxPrefix = 1:length(fileNamePrefix)
    ...
    for i = 1:lenth
        ...
        mask1(centerIm(1)-32:centerIm(1)+31,centerIm(2)-32:centerIm(2)+31) = 1;
